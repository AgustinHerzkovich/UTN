...
esNotaBochazo :: (Fractional a, Ord a, Num a) => a -> Bool
esNotaBochazo numero = numero < 6

aprobo :: (Fractional a, Ord a, Num a) => (a, a) -> Bool
aprobo (nota1, nota2) = (not . esNotaBochazo . (/ 2) . (+) nota1) nota2

promociono :: (Fractional a, Ord a, Num a) => (a, a) -> Bool
...
Main> (... algo ...) (5,8)
-- La consulta es (not . esNotaBochazo . fst) (nota1, nota2)
-}