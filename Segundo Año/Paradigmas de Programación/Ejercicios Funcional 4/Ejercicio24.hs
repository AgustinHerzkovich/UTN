huboMesMejorDe :: (Num a, Ord a) => [a] -> [a] -> a -> Bool
huboMesMejorDe ingreso egreso numero = any (> numero) (ingreso `restarListas` egreso)

restarListas :: (Num a) => [a] -> [a] -> [a]
restarListas = zipWith (-)

{-
Se representa la información sobre ingresos y egresos de una persona en cada mes de un año mediante dos listas, de 12 elementos cada una. P.ej., si entre enero y junio gané 100, y
entre julio y diciembre gané 120, mi lista de ingresos es:
